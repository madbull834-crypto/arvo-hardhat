...
const socialLinks = [
  { label: "Telegram", url: "https://t.me/arvoindia", icon: "telegram" },
  { label: "WhatsApp", url: "https://whatsapp.com/channel/0029Vb6xfcqFCCoRnmkUa21F", icon: "whatsapp" },
];
...
function socialIconSvg(icon) {
  if (icon === "telegram") {
    return `
      <svg viewBox="0 0 240 240" aria-hidden="true" focusable="false">
        ...
        <path fill="#fff" d="M179.7 72.2 157 179.4c-1.7 7.6-6.2 9.5-12.5 5.9l-34.6-25.5-16.7 16.1c-1.8 1.8-3.4 3.4-7 3.4l2.5-35.2 64.1-57.9c2.8-2.5-.6-3.9-4.3-1.4l-79.2 49.9-34.1-10.7c-7.4-2.3-7.6-7.4 1.5-10.9l133.4-51.4c6.2-2.3 11.6 1.5 9.6 10.5z"></path>
      </svg>
    `;
  }
  ...
  return `
    <svg viewBox="0 0 240 240" aria-hidden="true" focusable="false">
      <circle cx="120" cy="120" r="120" fill="#25D366"></circle>
      <path fill="#fff" d="M119.8 44.6c-40.5 0-73.5 32.9-73.5 73.4 0 13.8 3.9 27.2 11.1 38.8l-11.8 43.1 44.1-11.6c11.2 6.1 23.8 9.3 36.1 9.3h.1c40.5 0 73.4-32.9 73.4-73.4 0-19.6-7.6-38-21.5-51.9-13.9-13.8-32.3-21.5-52-21.5zm.1 140.5h-.1c-10.9 0-21.5-2.9-30.8-8.4l-2.2-1.3-26.2 6.9 7-25.5-1.4-2.6c-6.1-9.7-9.3-20.9-9.3-32.4 0-33.6 27.4-61 61.1-61 16.3 0 31.6 6.4 43.1 17.9 11.5 11.5 17.8 26.8 17.8 43.1 0 33.7-27.4 61-61 61z"></path>
      <path fill="#fff" d="M153.2 135.2c-1.8-.9-10.8-5.3-12.5-5.9-1.7-.6-2.9-.9-4.1.9-1.2 1.8-4.7 5.9-5.8 7.1-1.1 1.2-2.1 1.3-3.9.4-1.8-.9-7.7-2.8-14.6-9-5.4-4.8-9.1-10.8-10.2-12.6-1.1-1.8-.1-2.8.8-3.7.8-.8 1.8-2.1 2.7-3.2.9-1.1 1.2-1.8 1.8-3 .6-1.2.3-2.3-.1-3.2-.4-.9-4.1-9.9-5.6-13.5-1.5-3.6-3-3.1-4.1-3.1h-3.5c-1.2 0-3.2.4-4.8 2.3-1.7 1.8-6.3 6.2-6.3 15.1s6.5 17.5 7.4 18.7c.9 1.2 12.8 19.5 31 27.3 4.3 1.9 7.7 3 10.4 3.8 4.4 1.4 8.3 1.2 11.4.7 3.5-.5 10.8-4.4 12.3-8.7 1.5-4.3 1.5-8 1-8.7-.5-.8-1.6-1.2-3.4-2.1z"></path>
    </svg>
  `;
}
